...
/**
 * This is the model class for table "tbl_innovation".
 *
 * The followings are the available columns in table 'tbl_innovation':
 * @property integer $id
 * @property string $name
 * @property string $imagepath
 * @property string $content
 */
class Innovation extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
                    'innovationType' => array(self::BELONGS_TO, 'InnovationType', 'typeid'),
		);
	}
	 ...
	 * @return Innovation the static model class
	 */ 
       ...
       public function getTypeOptions(){
            ...
            $innovationoptions= InnovationType::model()->findAll();
            foreach($innovationoptions as $p) {
                $t[$p->id]=$p->type;                        
            }
            return $t;
        }
